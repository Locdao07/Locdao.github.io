...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $insert_query = "INSERT INTO users (username, password, tennd, email, dienthoai) VALUES ('$username', '$hashed_password', '$tennd', '$email', '$dienthoai')";
