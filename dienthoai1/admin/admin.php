...
// Redirect if the user is not logged in or has the wrong permission level
if (empty($_SESSION['username']) || $_SESSION['phanquyen'] == 1) {
    header('location: PHP/ch01/dienthoai1/login.php');
    exit();
}
?>
