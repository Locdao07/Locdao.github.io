<base href="http://localhost/PHP/ch01/dienthoai1/" />
<?php 
session_start();
...
<link rel="stylesheet" tyle="style/sheet" href="css/index.css">



<link rel="stylesheet" tyle="style/sheet" href="slide/engine/style.css">
...
<!-------------------------------------slide-------------------------------->
<link rel="stylesheet" tyle="style/sheet" href="css/style1.css">
	...
	<div id="footer">
		<div id="menu-footer">
			<ul>
				...
				<li><a href="gioithieu.php?content=gioithieu">GIỚI THIỆU</a></li>
				<li><a href="sanpham.php?content=sanpham">SẢN PHẨM</a>
				<li><a href="phukien.php?content=phukien">PHỤ KIỆN</a></li>
				<li><a href="khuyenmai.php?content=khuyenmai">KHUYỂN MÃI</a></li>
				<li><a href="tintuc.php?content=tintuc">TIN TỨC</a></li>
				<li><a href="hotro.php?content=hotro">HỖ TRỢ</a></li>
			</ul>
		</div><!-- End .menu-footer -->
		<div id="bg-footer">
